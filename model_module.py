...
class RTDLMModel(hk.Module):
    def __init__(self, config):
        ...
        self.final_layer = hk.Linear(config.vocab_size)  # ✅ No explicit PRNG in w_init
    ...
    def __call__(self, inputs):
        ...
        # ✅ Use Haiku’s internal PRNG management
        x = self.moe_layer(x, hk.next_rng_key(), is_training=True)
        x = self.final_layer(x)  # ✅ No explicit PRNG needed
