...
Usage:
    from src.core.training import EvaluationMetrics, MetricLogger, ValidationRunner
...
class EvaluationMetrics:
    ...
    def compute_token_accuracy(
        ...
        if top_k == 1:
            ...
            correct = jnp.any(top_k_preds == targets[:, :, None], axis=-1).astype(jnp.float32)
...
class TrainingEvaluator:
    ...
    def on_train_step(
        ...
        batch_metrics = self.metrics.compute_batch_metrics(logits, targets, loss, mask)
