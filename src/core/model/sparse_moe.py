...
def apply_router_jitter(
    logits: jnp.ndarray, rng_key, jitter_noise: float = 0.1, is_training: bool = True
) -> jnp.ndarray:
    """
...
class SparseMoE(hk.Module):
    ...
    def apply_spiking_attention(self, x, spike_threshold, epsilon):
        ...
        adaptive_threshold = jnp.percentile(importance_scores, (1.0 - spike_threshold) * 100)
