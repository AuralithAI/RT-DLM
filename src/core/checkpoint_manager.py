...
try:
    ...
    logging.warning("SafeTensors not installed. Install with: pip install safetensors>=0.4.0")
...
def save_model_weights(params: Dict, path: str, metadata: Optional[Dict] = None) -> str:
    """
...
def convert_pickle_to_safetensors(pickle_path: str, output_path: Optional[str] = None) -> str:
    """
