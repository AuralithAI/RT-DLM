...
class RetrievalAugmentedAttention(hk.Module):
    ...
    def __call__(
        ...
        # Final layer norm
        x = hk.LayerNorm(axis=-1, create_scale=True, create_offset=True, name="output_norm")(x)
...
class RetrievalAugmentedBlock(hk.Module):
    ...
    def __call__(
        ...
        # Residual and norm
        x = x + ff_output
        x = hk.LayerNorm(axis=-1, create_scale=True, create_offset=True, name="ff_norm")(x)
