...
def create_retrieval_train_step(
    ...
    def augmented_train_step(
        ...
        augmented_batch = retrieval_training.prepare_augmented_batch(batch, augment_key)
        ...
        new_params, new_opt_state, metrics = base_train_step(params, opt_state, batch, rng_key)
