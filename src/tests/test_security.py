...
class TestDataSanitizer(unittest.TestCase):
    ...
    def test_sanitize_list(self):
        ...
        data = {"emails": ["user1@test.com", "user2@test.com"], "notes": "Clean text"}
        sanitized = self.sanitizer.sanitize_dict(data)
    ...
    def test_custom_tokens(self):
        ...
        config = SanitizationConfig(replacement_tokens={PIIType.EMAIL: "***HIDDEN_EMAIL***"})
...
class TestSecureStorage(unittest.TestCase):
    ...
    def test_dict_encryption_roundtrip(self):
        ...
        original = {"user": "john", "score": 95.5, "tags": ["a", "b", "c"]}
