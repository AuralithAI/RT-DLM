...
class TestSelfAttentionShapes:
    ...
    @pytest.mark.parametrize("batch_size,seq_len", [(1, 8), (4, 32), (16, 64), (32, 16)])
...
class TestTransformerShapes:
    ...
    @pytest.mark.parametrize("batch_size,seq_len", [(1, 8), (4, 32), (16, 64)])
...
class TestAGIAttentionShapes:
    ...
    @pytest.mark.parametrize("batch_size,seq_len", [(1, 16), (4, 32), (8, 64)])
    def test_agi_attention_shapes(self, rng_key, batch_size, seq_len):
        """Test AGI attention output shapes."""
        from src.core.model.agi_attention import AGIAttention, AGIAttentionConfig
...
class TestHierarchicalMemoryFusionShapes:
    ...
    def test_memory_fusion_shapes(self, rng_key, batch_size):
        ...
        from src.core.model.agi_attention import HierarchicalMemoryFusion
