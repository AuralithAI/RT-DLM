...
class TestFeedbackCollector(unittest.TestCase):
    ...
    def test_feedback_score_validation_lower_bound(self):
        ...
        with self.assertRaises(ValueError):
            collector.collect(input_text="Test", output_text="Test", feedback_score=-0.1)
    ...
    def test_feedback_score_validation_upper_bound(self):
        ...
        with self.assertRaises(ValueError):
            collector.collect(input_text="Test", output_text="Test", feedback_score=1.1)
    ...
    def test_valid_feedback_score_boundaries(self):
        ...
        collector.collect(input_text="Test", output_text="Test", feedback_score=0.0)

        # Score of 1 should be valid
        collector.collect(input_text="Test", output_text="Test", feedback_score=1.0)
...
class TestGetFeedbackDataset(unittest.TestCase):
    ...
    def test_dataset_structure(self):
        ...
        collector.collect(input_text="Test input", output_text="Test output", feedback_score=0.75)
...
class TestClear(unittest.TestCase):
    ...
    def test_clear_allows_new_collection(self):
        ...
        collector.collect(input_text="Old", output_text="Data", feedback_score=0.5)

        collector.clear()

        collector.collect(input_text="New", output_text="Data", feedback_score=0.9)
...
class TestMetadataHandling(unittest.TestCase):
    ...
    def test_default_empty_metadata(self):
        ...
        collector.collect(input_text="Test", output_text="Test", feedback_score=0.5)
