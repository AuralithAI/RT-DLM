...
def list_tests():
    ...
    print("  python test_runner.py system      # Run system demo")
...
Examples:
  ...
  python test_runner.py --list          # List available tests
    ...
    parser.add_argument("test", nargs="?", help="Test to run (simple, hybrid, system, validator)")
    ...
    parser.add_argument("--full", action="store_true", help="Run all tests sequentially")
    ...
    if args.full:
        ...
        all_tests = ["simple", "validator", "system"]
        results = {}
