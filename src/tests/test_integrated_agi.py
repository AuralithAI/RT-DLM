...
class TestAGICapability(unittest.TestCase):
    ...
    def test_capability_creation(self):
        ...
        from src.modules.capabilities.integrated_agi_system import AGICapability, AGIStage
...
class TestTaskResponse(unittest.TestCase):
    ...
    def test_task_response_creation(self):
        ...
        from src.modules.capabilities.integrated_agi_system import TaskResponse, AGIStage
