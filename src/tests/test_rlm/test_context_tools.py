...
from src.config.rlm_config import ToolType, PartitionStrategy
...
class TestContextTools:
    ...
    def test_grep_regex(self, tools):
        # grep returns matching lines, not individual pattern occurrences
        tools._store.store("numbers", "ID: 123\nID: 456\nID: 789")
    ...
    def test_partition_success(self, tools):
        ...
        result = tools.partition("to_partition", chunk_size=100, overlap=20)
        assert result.success is True
