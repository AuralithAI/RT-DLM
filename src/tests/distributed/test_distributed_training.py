...
class TestParamSharding:
    ...
    def mesh(self):
        ...
        config = ModelParallelConfig(tensor_parallel=True, tensor_parallel_size=2)
        return ScalableMesh(config)

    def test_embedding_sharding(self, mesh):
        """Test embedding parameters get sharded on vocab dimension."""
        from src.core.scalable_training import get_param_sharding_spec

        spec = get_param_sharding_spec("model/embed/embeddings", (32000, 384), mesh)
    ...
    def test_attention_sharding(self, mesh):
        ...
        spec = get_param_sharding_spec("model/attention/query", (384, 384), mesh)
    ...
    def test_layernorm_not_sharded(self, mesh):
        ...
        spec = get_param_sharding_spec("model/layer_norm/scale", (384,), mesh)
...
class TestMemoryEstimation:
    ...
    def test_estimate_model_memory(self):
        ...
        from src.core.scalable_training import estimate_model_memory
    ...
    def test_recommend_parallelism_single_device(self):
        ...
        from src.core.scalable_training import recommend_parallelism
...
class TestDistributedValidation:
    ...
    def test_validate_distributed_setup(self):
        ...
        from src.config.model_parallel_config import ModelParallelConfig
        from src.core.scalable_training import ScalableMesh, validate_distributed_setup
...
class TestTrainStepCreation:
    ...
    def test_create_single_device_train_step(self, simple_model, simple_loss):
        ...
        from src.config.model_parallel_config import ModelParallelConfig
        from src.core.scalable_training import ScalableMesh, create_scalable_train_step
        import optax
        ...
        train_step = create_scalable_train_step(
            model_apply_fn=simple_model.apply, optimizer=optimizer, mesh=mesh, loss_fn=simple_loss
        )
...
class TestDistributedProfiler:
    ...
    def test_profiler_creation(self):
        ...
        from src.config.model_parallel_config import ModelParallelConfig
        from src.core.scalable_training import ScalableMesh, DistributedProfiler
...
class TestCheckpointCompatibility:
    ...
    def test_unreplicate_params(self):
        ...
        from src.core.scalable_training import unreplicate_params
...
class TestProfileCollectiveCommunication:
    ...
    def test_profile_single_device(self):
        ...
        from src.config.model_parallel_config import ModelParallelConfig
        from src.core.scalable_training import ScalableMesh, profile_collective_communication
