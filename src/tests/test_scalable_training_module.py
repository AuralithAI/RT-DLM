...
class TestScalableMesh(unittest.TestCase):
    ...
    def test_single_device_mesh(self):
        ...
        config = ModelParallelConfig(tensor_parallel=False, pipeline_parallel=False)
        mesh = ScalableMesh(config)
...
class TestModelParallelConfig(unittest.TestCase):
    ...
    def test_tensor_parallel_config(self):
        ...
        config = ModelParallelConfig(tensor_parallel=True, tensor_parallel_size=4)
    ...
    def test_pipeline_parallel_config(self):
        ...
        config = ModelParallelConfig(pipeline_parallel=True, pipeline_parallel_size=2)
...
class TestPipelineParallelism(unittest.TestCase):
    ...
    def test_pipeline_config(self):
        ...
        config = ModelParallelConfig(pipeline_parallel=True, pipeline_parallel_size=4)
