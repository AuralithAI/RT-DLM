...
class TestDocumentChunking:
    ...
    def test_fixed_chunking(self):
        ...
        chunker = TextChunker(chunk_size=100, chunk_overlap=20, strategy=ChunkingStrategy.FIXED)
    ...
    def test_sentence_chunking(self):
        ...
        chunker = TextChunker(chunk_size=50, chunk_overlap=10, strategy=ChunkingStrategy.SENTENCE)
    ...
    def test_recursive_chunking(self):
        ...
        chunker = TextChunker(chunk_size=50, chunk_overlap=10, strategy=ChunkingStrategy.RECURSIVE)
...
class TestSparseRetriever:
    ...
    def test_sparse_retriever_creation(self):
        ...
        from src.modules.retrieval.hybrid_retriever import SparseRetriever
...
class TestDenseRetriever:
    ...
    def test_dense_retriever_creation(self):
        ...
        from src.modules.retrieval.hybrid_retriever import DenseRetriever
...
class TestRetrievalAugmentedAttention:
    ...
    def test_retrieval_augmented_attention(self):
        ...
        from src.modules.retrieval.augmented_attention import RetrievalAugmentedAttention
        import haiku as hk
...
class TestContrastiveLoss:
    ...
    def test_contrastive_loss_basic(self):
        ...
        from src.modules.retrieval.training_integration import RetrievalContrastiveLoss
...
class TestTrainingIntegration:
    ...
    def test_augmented_batch_creation(self):
        ...
        from src.modules.retrieval.training_integration import RetrievalAugmentedTraining
        from src.config.retrieval_config import RetrievalConfig
