...
class TestHybridFusion:
    ...
    def test_ensemble_fusion_initialization(self, rng_key, d_model):
        ...
        from src.modules.hybrid_architecture.hybrid_integrator import EnsembleFusion
        ...
        batch_size = 2
        num_models = 4
        model_outputs = [jnp.ones((batch_size, d_model)) * (i + 1) for i in range(num_models)]
    ...
    def test_rbf_kernel_svm(self, rng_key, d_model):
        ...
        from src.modules.hybrid_architecture.hybrid_integrator import SVMLikeClassifier
    ...
    def test_cnn_branch_vectorized(self, rng_key, d_model):
        ...
        from src.modules.hybrid_architecture.hybrid_integrator import CNNBranch
    ...
    def test_full_hybrid_integrator(self, rng_key, d_model):
        ...
        batch_size = 2
        seq_len = 8
        inputs = {"text": jax.random.normal(rng_key, (batch_size, seq_len, d_model))}
