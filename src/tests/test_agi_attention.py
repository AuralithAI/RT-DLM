...
class TestCrossMemoryAttention:
    ...
    def test_cross_memory_basic(self):
        ...
        def forward(ltm, stm, mtm):
            cross_attn = CrossMemoryAttention(d_model=64, num_heads=4, dropout_rate=0.0)
    ...
    def test_cross_memory_sequence_input(self):
        ...
        def forward(ltm, stm, mtm):
            cross_attn = CrossMemoryAttention(d_model=64, num_heads=4)
...
class TestHierarchicalMemoryFusion:
    ...
    def test_hierarchical_fusion_basic(self):
        ...
        def forward(ltm, stm, mtm, context):
            fusion = HierarchicalMemoryFusion(d_model=64, num_heads=4, num_levels=3)
    ...
    def test_infinite_context_basic(self):
        ...
        def forward(x):
            infinite_attn = InfiniteContextAttention(
                d_model=64, num_heads=4, chunk_size=32, global_context_size=16, compression_ratio=4
            )
...
class TestFactoryFunctions:
    ...
    def test_create_agi_attention_presets(self):
        ...
        for preset in presets:
            ...
            def forward(x):
                agi_attn = create_agi_attention(d_model=64, num_heads=4, preset=preset)
