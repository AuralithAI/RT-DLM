...
class TestAdvancedSelfAttention:
    ...
    def test_gqa_attention(self):
        ...
        config = AttentionConfig(
            d_model=64, num_heads=8, num_kv_heads=2, attention_type="gqa", position_encoding="rope"
        )
        vocab_size = 1000
    ...
    def test_spiking_integration(self):
        ...
        config = AttentionConfig(d_model=64, num_heads=4, enable_spiking=True, spike_threshold=0.1)
        vocab_size = 500
...
class TestConfigFactory:
    ...
    def test_create_gqa_config(self):
        ...
        config = create_attention_config(d_model=512, num_heads=8, attention_type="gqa")
    ...
    def test_create_mqa_config(self):
        ...
        config = create_attention_config(d_model=512, num_heads=8, attention_type="mqa")
    ...
    def test_create_rope_config(self):
        ...
        config = create_attention_config(position_encoding="rope", rope_theta=10000.0)
...
class TestUtilityFunctions:
    ...
    def test_compute_attention_flops_standard(self):
        ...
        flops = compute_attention_flops(batch_size=4, seq_len=1024, d_model=512, num_heads=8)
    ...
    def test_compute_attention_flops_linear(self):
        ...
        flops_standard = compute_attention_flops(
            batch_size=4, seq_len=1024, d_model=512, num_heads=8, attention_type="standard"
        )
        flops_linear = compute_attention_flops(
            batch_size=4, seq_len=1024, d_model=512, num_heads=8, attention_type="linear"
        )
