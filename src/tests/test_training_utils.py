...
class TestMixedPrecisionPolicy:
    ...
    def test_float16_policy(self):
        ...
        policy = MixedPrecisionPolicy(param_dtype="float16", compute_dtype="float16")
...
class TestGradientCheckpointing:
    ...
    def test_checkpointing_config_default(self):
        ...
        from src.core.training_utils import GradientCheckpointingConfig
    ...
    def test_checkpointing_config_enabled(self):
        ...
        config = GradientCheckpointingConfig(enabled=True, checkpoint_every_n_layers=3)
    ...
    def test_create_checkpointed_layer(self):
        ...
        from src.core.training_utils import create_checkpointed_layer
...
class TestDistributedTraining:
    ...
    def test_shard_batch(self):
        ...
        from src.core.training_utils import shard_batch_for_devices
    ...
    def test_unshard_batch(self):
        ...
        from src.core.training_utils import shard_batch_for_devices, unshard_batch
...
class TestGradientAccumulator:
    ...
    def test_accumulator_initialization(self):
        ...
        from src.core.training_utils import GradientAccumulator
...
class TestTrainingOptimizations:
    ...
    def test_from_config(self):
        ...
        from src.core.training_utils import TrainingOptimizations
...
class TestMemoryUtilities:
    ...
    def test_get_memory_stats(self):
        ...
        from src.core.training_utils import get_memory_stats
