...
class TestQuantizeTensor(unittest.TestCase):
    ...
    def test_quantize_tensor_int8(self):
        ...
        from src.core.quantization.quantize import compute_scale_zero_point, quantize_tensor

        tensor = jnp.array([[1.0, 2.0, 3.0, 4.0]])
        scale, zero_point = compute_scale_zero_point(tensor, bits=8, symmetric=True)
    ...
    def test_quantize_tensor_int4(self):
        ...
        tensor = jnp.array([[1.0, 2.0, 3.0, 4.0]])
        scale, zero_point = compute_scale_zero_point(tensor, bits=4, symmetric=True)
...
class TestDequantizeTensor(unittest.TestCase):
    ...
    def test_dequantize_tensor(self):
        ...
        scale, zero_point = compute_scale_zero_point(original, bits=8, symmetric=True)
